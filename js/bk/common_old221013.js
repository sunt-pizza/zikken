...
// }
setInterval(() => {
        // const rotate3d = document.querySelectorAll(".icon-cards__content"); 
        // rotate3d.style.cssText = 'animation: carousel 10s infinite ease-in running forwards;';
        // const rotate3d = Element.getAnimations(subtree: true);
    
        // document.getElementsByClassName("icon-cards__content").animate([
